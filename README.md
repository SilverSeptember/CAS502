...
## Description
Project implements a measles epidemic model. It was reconfigured from a Jupyter Notebook into a structured Python package. This course project includes:
 - Tkinter based GUI
...
- Click **Run Simulation** to compute:
  * SIR model
  * SIRS model
  * Extended SIRS with demography and migration
...
- The **Model Narrative** panel on the right displays:
